...
const Hero = () => {
    return (
        <div className='text-white ' >
            <div className='max-w-[800px] mt-[96px] w-full sm:mx-auto px-8 text-center flex flex-col  min-h-screen'>
                ...
                <p className='md:text-2xl sm:text-xl text-gray-600'>Thousands of movies, together with analysis of their rating history.</p>
                <Link to="/movies">
